...
function censor(fromWord, toWord) {
  return (str)=>str.includes(fromWord)?str.replace(fromWord,toWord):str;
}
...
function multipleCensor() {
  ...
  return (arg1,arg2) => {
    ...
    if(arg2==undefined){
      return arg1.includes(array[0])?arg1.replace(array[0],array[1]):arg1;
    }
  }
}
